...
function dTree(objName) {
	...
	this.icon = {
		root				: '/admin/dtree/img/base.gif',
		folder			: '/admin/dtree/img/folder.gif',
		folderOpen	: '/admin/dtree/img/folderopen.gif',
		node				: '/admin/dtree/img/page.gif',
		empty				: '/admin/dtree/img/empty.gif',
		line				: '/admin/dtree/img/line.gif',
		join				: '/admin/dtree/img/join.gif',
		joinBottom	: '/admin/dtree/img/joinbottom.gif',
		plus				: '/admin/dtree/img/plus.gif',
		plusBottom	: '/admin/dtree/img/plusbottom.gif',
		minus				: '/admin/dtree/img/minus.gif',
		minusBottom	: '/admin/dtree/img/minusbottom.gif',
		nlPlus			: '/admin/dtree/img/nolines_plus.gif',
		nlMinus			: '/admin/dtree/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.add = function(id, pid, cname, cvalue, cshow, cchecked, cdisabled, url, title, target, icon, iconOpen, open) {
	this.aNodes[id] = new Node(id, pid, cname, cvalue, cshow, cchecked, cdisabled, url, title, target, icon, iconOpen, open);
};
...
dTree.prototype.node = function(node, nodeId) {
	var str = '<div class="dTreeNode" data-id="'+nodeId+'" data-pid="'+node.pid+'">' + this.indent(node, nodeId);
	...
	if (node.url || ((!this.config.folderLinks || !node.url) && node._hc)){
		if(node.pid == -1){
			str += '</a><i class="fa fa-plus tree-opt opt-add"></i></i>';
		}else{
			str += '</a><i class="fa fa-pencil tree-opt opt-edit"></i><i class="fa fa-plus tree-opt opt-add"></i><i class="fa fa-trash-o tree-opt opt-del"></i>';
		}
...
dTree.prototype.openTo = function(nId, bSelect, bFirst) {
	...
	cn._io = true;
	cn._is = bSelect;
	if (this.completed && cn._hc) this.nodeStatus(true, cn.id, cn._ls);
